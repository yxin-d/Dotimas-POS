  ...
  return (
    <div className="flex items-start gap-2 py-2 border-b border-border last:border-0">
      <div className="flex-1 min-w-0">
        ...
        <p className="text-xs text-ink-faint tabular">{formatPeso(product.price)} each</p>
      </div>
      ...
      <div className="flex flex-col items-end gap-1 shrink-0">
        ...
        <div className="flex items-center gap-1">
          ...
          <button
            ...
            className="w-6 h-6 rounded-md bg-surface-sunken hover:bg-border flex items-center justify-center transition-colors disabled:opacity-30"
          >
            <Plus size={10} />
          </button>
          <button
